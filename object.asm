...
; ----------------------------------------------------------------------------
; 內容物屬性
game_name_attribute     WORD        game_name_xdim DUP(white)
; ----------------------------------------------------------------------------
game_name_contents      BYTE        " _______    ______   __    __    ______       _______    __    __   __    __ "
                        BYTE        "|       \  |      \ |  \  |  \  /      \     |       \  |  \  |  \ |  \  |  \"
                        BYTE        "| $$$$$$$\  \$$$$$$ | $$\ | $$ |  $$$$$$\    | $$$$$$$\ | $$  | $$ | $$\ | $$"
                        BYTE        "| $$  | $$   | $$   | $$$\| $$ | $$  | $$    | $$__| $$ | $$  | $$ | $$$\| $$"
                        BYTE        "| $$  | $$   | $$   | $$$$\ $$ | $$  | $$    | $$    $$ | $$  | $$ | $$$$\ $$"
...
; ----------------------------------------------------------------------------
; 物件: 遊戲名稱文字
game_name_str          OBJECT       << OFFSET game_name_contents,           \
                                       OFFSET game_name_attribute,          \
                                       < game_name_xdim, game_name_ydim >  >>
